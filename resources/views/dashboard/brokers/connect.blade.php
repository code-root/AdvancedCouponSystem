        ...
        <div class="pc-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Connect Broker</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="mb-3 text-end">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="mb-1 fw-bold">Connect New Broker</h4>
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="card border-0 shadow-sm h-100 broker-card" data-broker="{{ $broker }}">
                        <div class="card-body">
                            ...
                            <div class="d-grid">
                                <button class="btn btn-primary" onclick="connectBroker('{{ $broker }}')">
    ...
    $('#connectionForm').on('submit', function(e) {
        ...
        .then(data => {
            if (data.success) {
                ...
                setTimeout(() => {
                    window.location.href = `{{ route('brokers.index') }}/${selectedBroker}`;
                }, 1500);
            } else {
