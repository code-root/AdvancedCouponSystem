@extends('layouts.vertical', ['title' => 'Connect Broker'])
...
@section('content')
    @include('layouts.partials.page-title', ['subtitle' => 'Brokers', 'title' => 'Connect New Broker'])
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header border-bottom border-dashed">
                        <h4 class="card-title mb-0">Broker Connection Details</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <!-- Select Broker -->
                            <div class="col-12 mb-3">
                                ...
                                <select class="form-select" name="broker_id" id="brokerSelect" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <small class="text-muted">Broker's API URL</small>
                            </div>
                ...
                <div class="card bg-primary-subtle border-primary border-dashed" id="brokerInfoCard" style="display: none;">
                    <div class="card-body">
                        <div class="text-center mb-3">
                            ...
                            <h5 class="fw-semibold mb-1" id="sidebarBrokerName">Select a Broker</h5>
                            <p class="text-muted mb-0" id="sidebarBrokerCountry"></p>
                        </div>

                        <div class="border-top border-dashed border-primary pt-3" id="sidebarDetails" style="display: none;">
                            <h6 class="text-uppercase text-muted mb-3">Broker Details</h6>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex gap-2 mb-3">
                            ...
                            <div>
                                <h6 class="mb-1">Select Broker</h6>
...
$(document).ready(function() {
    ...
    $('#brokerSelect').on('change', function() {
        ...
        if (selectedOption.val()) {
            // Update sidebar
            $('#sidebarBrokerName').text(selectedOption.data('display'));
            $('#sidebarBrokerCountry').text(selectedOption.data('country'));
