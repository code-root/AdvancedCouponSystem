@extends('dashboard.layouts.vertical', ['title' => 'Create Sync Schedule'])

@section('content')
    @include('dashboard.layouts.partials.page-title', ['subtitle' => 'Data Sync', 'title' => 'Create New Schedule'])

    <form action="{{ route('dashboard.sync.schedules.store') }}" method="POST">
        @csrf
