@extends('dashboard.layouts.vertical', ['title' => 'Edit Sync Schedule'])

@section('content')
    @include('dashboard.layouts.partials.page-title', ['subtitle' => 'Data Sync', 'title' => 'Edit Schedule'])

    <form action="{{ route('dashboard.sync.schedules.update', $schedule->id) }}" method="POST">
        @csrf
        @method('PUT')
