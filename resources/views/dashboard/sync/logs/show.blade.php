@extends('dashboard.layouts.vertical', ['title' => 'Sync Log Details'])

@section('content')
    @include('dashboard.layouts.partials.page-title', ['subtitle' => 'Data Sync', 'title' => 'Sync Log Details'])
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="mb-0">
                                @if($log->syncSchedule)
                                    <a href="{{ route('dashboard.sync.schedules.edit', $log->syncSchedule->id) }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        @if($log->syncSchedule)
                            <a href="{{ route('dashboard.sync.schedules.edit', $log->syncSchedule->id) }}" class="btn btn-primary">
                        ...
                        @else
                            <div class="list-group list-group-flush">
                                @foreach($recentLogs as $recentLog)
                                    <a href="{{ route('dashboard.sync.logs.show', $recentLog->id) }}" class="list-group-item list-group-item-action">
