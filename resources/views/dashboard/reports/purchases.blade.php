@extends('dashboard.layouts.vertical', ['title' => 'Purchase Reports'])
...
@section('content')
    @include('dashboard.layouts.partials.page-title', ['subtitle' => 'Reports', 'title' => 'Purchase Analytics'])
    ...
    <div class="row row-cols-xxl-6 row-cols-md-3 row-cols-1 text-center">
        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <h5 class="text-muted fs-13 text-uppercase">revenue</h5>
                    <h3 class="mb-0 fw-bold text-info" id="stat-revenue">$0</h3>
                </div>
            </div>
        </div>
    </div>
