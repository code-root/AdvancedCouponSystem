@extends('layouts.vertical', ['title' => 'Sync Settings'])

@section('content')
    @include('layouts.partials.page-title', ['subtitle' => 'Data Sync', 'title' => 'Sync Settings'])
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('sync.schedules.create') }}" class="btn btn-primary">
