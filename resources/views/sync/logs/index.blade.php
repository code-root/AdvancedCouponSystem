@extends('layouts.vertical', ['title' => 'Sync Logs'])
...
@section('content')
    @include('layouts.partials.page-title', ['subtitle' => 'Data Sync', 'title' => 'Sync Logs'])
                                    ...
                                    @foreach($logs as $log)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('sync.logs.show', $log->id) }}" class="btn btn-sm btn-light">
