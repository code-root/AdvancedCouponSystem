@extends('layouts.vertical', ['title' => 'Sync Schedules'])

@section('content')
    @include('layouts.partials.page-title', ['subtitle' => 'Data Sync', 'title' => 'Sync Schedules'])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom border-light d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('sync.schedules.create') }}" class="btn btn-primary btn-sm">
                ...
                <div class="card-body">
                    @if($schedules->isEmpty())
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('sync.schedules.create') }}" class="btn btn-primary btn-sm mt-3">
                                        ...
                                        <tr id="schedule-{{ $schedule->id }}">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group btn-group-sm">
                                                    ...
                                                    <a href="{{ route('sync.schedules.edit', $schedule->id) }}" class="btn btn-light" title="Edit">
